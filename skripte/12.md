...
Pokretanje SonarScanner-a za početak analize:
```bash
...
* /k:"backAPI": Specifikuje ključ projekta (project key) koji je jedinstven identifikator za vaš projekat u SonarQube-u.
