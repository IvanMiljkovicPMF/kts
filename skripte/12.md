...
```bash
"SonarScanner installation path"\SonarScanner.MSBuild.exe begin /k:"backAPI" /d:sonar.host.url="http://localhost:9000" /d:sonar.token="sqp_4d27d41c1d5958f8162e40ecf06a43692986630"
```
```bash
...
```
```bash
"SonarScanner installation path"\SonarScanner.MSBuild.exe end /d:sonar.token="sqp_4d27d41c1d5958f8162e40ecf06a43692986630"
```
![image](https://github.com/user-attachments/assets/f4b8cbce-69a1-42a4-a003-75ace2873325)
