...
* [Analiza pokrivenosti koda (Code Coverage)](#analiza-pokrivenosti-koda-code-coverage)
  * [Analiza Kvaliteta Koda Projekta](#analiza-kvaliteta-koda-projekta)
    * [1. Overview (Pregled)](#1-overview-pregled)
    * [2. Issues (Problemi)](#issues-problemi)
    * [3. Security Hotspots (Sigurnosne Tačke)](#security-hotspots-sigurnosne-tačke)
    * [4. Measures (Metrike)](#measures-metrike)
    * [5. Code (Kod)](#code-kod)
    * [6. Activity (Aktivnost)](#activity-aktivnost)
